...
git add README.md docs .gitignore ml_0730/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-d356df58-5967.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-d356df58-5967.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[ml-0730/databricks.yml](../ml_0730/databricks.yml) file.
...
Follow the instructions in [ml-0730/resources/README.md](../ml_0730/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../ml_0730/resources/README.md)  to propose, test, and deploy
